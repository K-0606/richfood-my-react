...
import "../MySearch/HomeImage"; // 引入樣式檔案
...
function HomeHeroImage() {
  ...
  //   const cuisineValues = cuisines.length
  //     ? cuisines.map((cuisine) => cuisine.value).join(",")
  //     : "";
  //   const regionValues = regions.length
  //     ? regions.map((region) => region.value).join(",")
  //     : "";

  // // 拼接 URL 並導航
  // navigate(
  //   `/search?region=${regionValues}&type=${cuisineValues}&price=&popular=false`
  // );
  // };
